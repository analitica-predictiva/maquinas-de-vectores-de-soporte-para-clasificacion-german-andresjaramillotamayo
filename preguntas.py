...
def pregunta_03():
    ...
    columnas_texto = ['checking_balance', 'credit_history', 'purpose', 'savings_balance', 'employment_length', 'personal_status', 'other_debtors', 'property', 'installment_plan', 'housing', 'telephone', 'foreign_worker', 'job']
    ...
    columnTransformer = make_column_transformer(
        ...
        remainder='passthrough',  # Las columnas numéricas no transformadas.
    )
